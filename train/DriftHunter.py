...
class UtteranceAttention(nn.Module):
    ...
    def forward(self,p):
        ...
        return H
class DriftHunterDecoder(nn.Module):
    def __init__(self,bert_dim,utterance_embedding):
        super(DriftHunterDecoder,self).__init__()
...
class DriftHunter(nn.Module):
    def __init__(self,bert_dim,utterance_embedding,intent_number,slots_number,l=0.2):
        ...
        self.DriftHunter_intent_decoder=DriftHunterDecoder(bert_dim,utterance_embedding)
        self.DriftHunter_slot_decoder=DriftHunterDecoder(bert_dim,utterance_embedding)
        self.l=l
    ...
    def forward(self,intent_embedding,slots_embedding,u):
        ...
        intent_enhance_embedding1,slot_enhance_embedding1=self.DriftHunter_intent_decoder(intent_original,H)
        intent_enhance_embedding2,slot_enhance_embedding2=self.DriftHunter_slot_decoder(slots_original,H)
